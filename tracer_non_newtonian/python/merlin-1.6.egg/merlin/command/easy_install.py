    ...
    def install_script(self, dist, script_name, script_text, dev_path=None):
        ...
        if is_script and dev_path:
            script_text = get_script_header(script_text) + (
                ...
                "__requires__ = %(spec)r\n"
                "from merlin import require; require(%(spec)r)\n"
                "del require\n"
                "__file__ = %(dev_path)r\n"
                "execfile(__file__)\n"
            ) % locals()
            ...
            script_text = get_script_header(script_text) + (
                ...
                "__requires__ = %(spec)r\n"
                "import merlin\n"
                "merlin.run_script(%(spec)r, %(script_name)r)\n"
            ) % locals()
...
these examples, in order to select the desired version:
    ...
    merlin.require("%(name)s")  # latest installed version
    merlin.require("%(name)s==%(version)s")  # this exact version
    merlin.require("%(name)s>=%(version)s")  # this version or higher
"""
