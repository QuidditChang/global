	...
	if(E->parallel.me==0)
	    ...
	    /* initialize tracer flavors (for 3D model only) */
            if(E->monitor.solution_cycles >= 0 && age1>=380.0) {
               if(dist>0.1 && E->trace.extraq[j][0][kk]==0.0 && age1>3000.0 && E->monitor.solution_cycles == 0) {
		    if(rad>0.997)
		    ...
		    if(rad>0.997)
              ...
              /* else if(rad>0.98 && E->monitor.solution_cycles > 0 && flag_depth2<0.0 && dist>0.1) {
                    if(rad>0.997)
                      E->trace.extraq[j][0][kk]=cuc;
                    else if(rad>0.994)
                      E->trace.extraq[j][0][kk]=clc;
	    ...
	    if(age1>0.0 && age1<380.0 && (flag_depth2>=0.0 || dist>=0.08)) { // && E->sx[j][2][node]<0.23) {
           ...
           // oceanic crust overriding plate
