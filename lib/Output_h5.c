...
void h5output_meta(struct All_variables *E)
{
    ...
    status = set_attribute_int(input, "ala_element_vanka_smoother",
    ...
    status = set_attribute_double(input, "ala_element_vanka_pressure_damping",
    ...
    status = set_attribute_double(
        input, "ala_element_vanka_external_diagonal_weight",
        E->control.ala_element_vanka_external_diagonal_weight);
    status = set_attribute_int(input, "ala_element_vanka_galerkin_schur",
                               E->control.ala_element_vanka_galerkin_schur);
    ...
    status = set_attribute_int(input, "ala_pressure_multigrid_galerkin",
    ...
    status = set_attribute_int(input, "ala_pressure_multigrid_post_smooth",
    ...
    status = set_attribute_double(input, "ala_pressure_multigrid_damping",
                                  E->control.ala_pressure_multigrid_damping);
    status = set_attribute_double(input, "ala_pressure_multigrid_weight",
    ...
    status = set_attribute_int(input, "ala_shallow_patch_highpass",
    ...
    status = set_attribute_int(
        input, "ala_coupled_factor2_coarse_correction",
        E->control.ala_coupled_factor2_coarse_correction);
    status = set_attribute_int(input, "ala_coupled_multilevel_audit_only",
                               E->control.ala_coupled_multilevel_audit_only);
    status = set_attribute_int(
    ...
    status = set_attribute_int(
        input, "ala_coupled_shallow_vanka_band_sweeps",
