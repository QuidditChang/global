...
void count_tracers_of_flavors(struct All_variables *E)
{
    ...
    int j, flavor, e, kk, i;
    int numtracers,nox,noy,intage,num1,num2,num3,num4,num5,num6;
    ...
    double PI=3.1415926;
    double inputdata,tmp1,tmp2,*geomx1,*geomy1,*geomx2,*geomy2,*geomx3,*geomy3,*geomy4,*geomx4,*geomy5,*geomx5,*geomy6,*geomx6;
	...
	if(E->parallel.me==0)
        ...
        numtracers=E->trace.ntracers[j];
	/*define LLSVPs from topoography*/
	if (E->monitor.solution_cycles == 0){
	   ...
	   /*if(E->monitor.solution_cycles==0 && age1==0.0 && rad>0.996) {
	    ...
	    /* add a chemical layer above CMB */
            if (E->monitor.solution_cycles==0){
	        if((isptin(geomx4,geomy4,num4,phi,theta)!=0 ||isptin(geomx5,geomy5,num5,phi,theta)!=0||isptin(geomx6,geomy6,num6,phi,theta)!=0) && rad<E->sphere.ri+400.0/6371.0)
