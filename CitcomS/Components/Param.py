...
class Param(CitcomComponent):
    ...
    def SbiParam(self,rayleigh):
        if rayleigh < 0.0:
            self.inventory.start_age = 0
	...
	flag_depth_new_file = pyre.inventory.str("flag_depth_new_file",default="flag_depth_new.dat")
...
# version
__id__ = "$Id: Param.py 8021 2007-09-25 01:31:30Z tan2 $"
