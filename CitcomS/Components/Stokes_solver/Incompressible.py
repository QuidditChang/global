...
class Incompressible(CitcomComponent):
    ...
    class Inventory(CitcomComponent.Inventory):
        ...
        ala_schur_diagnostic = prop.bool(
        ...
        ala_shallow_patch_mid_depth_km = prop.float(
            "ala_shallow_patch_mid_depth_km", default=200.0)
        ala_shallow_patch_transition_depth_km = prop.float(
            "ala_shallow_patch_transition_depth_km", default=410.0)
        ala_shallow_patch_mid_action_scale = prop.float(
            "ala_shallow_patch_mid_action_scale", default=1.0)
        ala_shallow_patch_transition_action_scale = prop.float(
            "ala_shallow_patch_transition_action_scale", default=1.0)
        ...
        ala_shallow_patch_local_operator = prop.str(
            "ala_shallow_patch_local_operator", default="legacy",
            validator=prop.choice(["legacy", "operator_consistent"]))
