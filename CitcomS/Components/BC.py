...
class BC(CitcomComponent):
    ...
    def SbiBC(self,rayleigh):
	if rayleigh < 0.0:
        	self.inventory.topvbxval = -self.inventory.topvbxval
        	self.inventory.topvbyval = -self.inventory.topvbyval
        return
...
# version
__id__ = "$Id: BC.py 4957 2006-10-12 14:48:43Z leif $"
