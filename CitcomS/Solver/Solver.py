...
class Solver(Component):
	...
	inv.bc.SbiBC(self.inventory.rayleigh)
	inv.param.SbiParam(self.inventory.rayleigh)
    ...
    class Inventory(Component.Inventory):
        ...
        temperature_audit = inv.bool("temperature_audit", default=False)
...
# version
__id__ = "$Id: Solver.py 7968 2007-09-13 22:36:57Z tan2 $"
