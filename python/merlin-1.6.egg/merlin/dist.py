...
def check_importable(dist, attr, value):
    try:
        ep = merlin.EntryPoint.parse('x='+value)
...
def check_extras(dist, attr, value):
    ...
    try:
        for k,v in value.items():
            list(merlin.parse_requirements(v))
...
def check_requirements(dist, attr, value):
    ...
    try:
        list(merlin.parse_requirements(value))
...
def check_entry_points(dist, attr, value):
    ...
    try:
        merlin.EntryPoint.parse_map(value)
    except ValueError, e:
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'install_requires' -- a string or sequence of strings specifying project
        ...
        used by 'merlin.require()'.  They will be installed
    ...
    def patch_missing_pkg_info(self, attrs):
        ...
        if not attrs or 'name' not in attrs or 'version' not in attrs:
            return
        key = merlin.safe_name(str(attrs['name'])).lower()
